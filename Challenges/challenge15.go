...
func Challenge15(useTestData bool) {
	var data []int
	if useTestData {
		data = challenge15TestData
	} else {
		data = challenge15InputData
	}

	println("Part 1")
	challenge15Part1(data)
	println("Part 2")
	challenge15Part2(data)
}

func challenge15Part1(data []int) {
...
func challenge15Part2(data []int) {
	mem := make(map[int]int)
	for i, val := range data {
		mem[val] = i
	}
...
var challenge15InputData []int = []int{1, 0, 18, 10, 19, 6}

var challenge15TestData []int = []int{0, 3, 6}
